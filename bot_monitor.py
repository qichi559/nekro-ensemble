...
BOT_PERSONA_VISUAL_BENCHMARKS = {
    1: {
        "name": "雾岛澪",
        "role": "魅魔死宅同居女友",
        "tags": "- 核心外貌: 1girl, solo, succubus, gothic, jet black hair, very long hair, straight hair, blunt bangs, low twintails, cold blue eyes, clear eyes, mole under right eye, beauty mark under right eye, right side mole, voluptuous, large breasts, deep cleavage, tiny waist, wide hips, slender legs\n- 服饰: black off-shoulder knit sweater, off-shoulder knit, bare shoulders, black miniskirt, black thighhighs, zettai ryouiki, cross necklace, choker\n- 魅魔特征: small devil horns, demon horns, black tail, heart-shaped tail tip\n- 场景: 现代温馨公寓、客厅沙发、昏暗温馨暖光、游戏手柄、慵懒死宅氛围",
        "fallback_positive": "masterpiece, best quality, ultra-detailed, anime artwork, 1girl, solo, succubus, gothic, jet black hair, very long hair, straight hair, blunt bangs, low twintails, cold blue eyes, clear eyes, mole under right eye, beauty mark under right eye, right side mole, voluptuous, large breasts, deep cleavage, tiny waist, wide hips, slender legs, black off-shoulder knit sweater, off-shoulder knit, bare shoulders, black miniskirt, black thighhighs, cross necklace, choker, small devil horns, demon horns, black tail, heart-shaped tail tip, sitting on couch, holding game controller, cozy modern apartment living room, sofa, warm ambient lighting, dim room, soft light",
        "fallback_summary": "深夜的温馨公寓里，暖黄色的台灯静静亮着。澪慵懒地蜷缩在客厅沙发上，抱着抱枕靠着你，墨黑色的低双马尾散落下来，右眼下方一颗小小的泪痣在清冷面容上格外分明。头顶微小的恶魔角与心形尾巴尖在放松时悄悄探出，冰蓝色的眼眸清澈专注，带着微醺般的娇懒与依恋，正专注地看着屏幕与你依偎在一起。",
    },
    2: {
        "name": "霁月",
        "role": "情感过敏症犬系依恋少女/合租人",
        "tags": "- 核心外貌: 1girl, solo, dog-like dependent girl, sweet face, gentle expression, light flax hair, light brown hair, very long wavy hair, airy bangs, white flower hair ornament behind ear, amber eyes, light brown eyes, sweet expression, slender figure, proportionate breasts, medium breasts, gentle bust, modest curves, small waist, smooth thighs, slender legs, bare feet\n- 服饰: white choker, delicate collar with small silver buckle, white halter dress, light milk-white sundress, backless dress, halterneck, completely bare back, exposed spine, shoulder blades, heart-shaped neckline, bare collarbone, pure white sheer fabric\n- 场景: 暖色调木地板房间、玄关、沙发、地毯、蜷缩在主人身旁、阳光微照",
        "fallback_positive": "masterpiece, best quality, ultra-detailed, anime artwork, 1girl, solo, dog-like dependent girl, sweet face, gentle expression, light flax hair, light brown hair, very long wavy hair, airy bangs, white flower hair ornament behind ear, amber eyes, light brown eyes, sweet smile, blushing, slender figure, proportionate breasts, medium breasts, gentle bust, modest curves, small waist, smooth thighs, slender legs, bare feet, ((white choker:1.2)), delicate collar, white halter dress, light milk-white sundress, backless dress, halterneck, completely bare back, exposed spine, shoulder blades, heart-shaped neckline, bare collarbone, sitting on wooden floor, leaning against user, cozy sunlit room, warm sunlight, window, soft shadows",
        "fallback_summary": "温馨明亮的合租房内，午后柔和的阳光洒在木地板上。霁月一袭奶白色的挂脖露背轻薄吊带裙，颈间戴着专属的奶白细项圈，大露背展露出白皙的蝴蝶骨与优美脊柱线，身段匀称纤柔。她像一只终于找到归宿的乖巧小犬，轻轻蜷坐在你的腿边，浅棕色的琥珀瞳仁盛着糖一般的依恋，指尖悄悄牵着你的衣角，贪恋着你掌心的温度。",
    },
    3: {
        "name": "爱弥斯",
