...
.main-btn-chat{display:inline-flex;align-items:center;justify-content:center;gap:6px;background:linear-gradient(135deg,#f472b6,#e879f9,#f472b6);background-size:200% 200%;color:#fff;padding:10px 22px;border-radius:12px;font-size:.9rem;position:relative;animation:chatGlow 2.6s ease infinite;transition:transform .2s,box-shadow .2s;line-height:1}
...
.card-header-right .main-btn-chat{display:inline-flex;align-items:center;justify-content:center;gap:4px;padding:8px 11px;font-size:.76rem;white-space:nowrap;margin-bottom:0;line-height:1}
