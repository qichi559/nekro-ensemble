...
.card-header-right .main-btn-chat{display:inline-flex;align-items:center;justify-content:center;gap:4px;padding:8px 12px;font-size:.78rem;white-space:nowrap;margin-bottom:0;line-height:1;width:max-content;min-width:0}
